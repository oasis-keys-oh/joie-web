...
/**
 * Trip layout — wraps all /trip/* pages only.
 * Provides NavBar, PersonaProvider, ServiceWorker, and footer.
 * Admin pages have their own layout and must NOT get this chrome.
 */
